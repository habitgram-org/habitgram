const Ziggy = {
    ...
    routes: {
        ...
        'habits.index': { uri: 'habits', methods: ['GET', 'HEAD'] },
        'habits.create': { uri: 'habits\/create', methods: ['GET', 'HEAD'] },
        'habits.store': { uri: 'habits', methods: ['POST'] },
        'habits.show': {
            uri: 'habits\/{habit}',
            methods: ['GET', 'HEAD'],
            parameters: ['habit'],
        ...
        'habits.entries.show': {
            uri: 'habits\/{habit}\/entries\/{entry}',
            methods: ['GET', 'HEAD'],
            parameters: ['habit', 'entry'],
        },
