...
export default function CountHabitDetails({ habit }: Props) {
    ...
    useEffect(() => {
        if (flash?.newly_added_amount) {
            toast.success(
                `Added +${flash.newly_added_amount} ${countHabit.unit}`,
            );
        }
    }, [flash, countHabit.unit]);
    ...
    return (
        <div className="min-h-screen bg-linear-to-b from-slate-50 to-white p-4 md:p-6 lg:p-8">
            <div className="mx-auto max-w-2xl space-y-6">
                ...
                <Card className="border-emerald-100 bg-linear-to-br from-emerald-50 to-teal-50 p-8 md:p-12">
                    <div className="space-y-4 text-center">
                        <div className="space-y-2">
                            <div
                                id="counter"
                                className={`bg-linear-to-r from-emerald-600 to-teal-600 bg-clip-text text-7xl font-bold text-transparent transition-transform duration-300 md:text-8xl lg:text-9xl`}
                            >
                                {countHabit.total}
                            </div>
                        ...
                        <div className="flex items-center justify-center gap-3 pt-4">
                            <Button
                                ...
                                className="h-14 rounded-full bg-linear-to-r from-emerald-600 to-teal-600 px-8 hover:from-emerald-700 hover:to-teal-700"
                            >
                ...
                {/* Quick Add Buttons */}
                {countHabit.quick_amounts.length > 0 && (
                    <div className="flex flex-col items-center gap-3">
                        ...
                        <div className="no-scrollbar flex max-w-full gap-3 overflow-x-auto px-2 pb-2">
                            {countHabit.quick_amounts.map((amount) => (
                                <Form
                                    key={amount}
                                    method="POST"
                                    action={route(
            ...
            <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                <DialogContent className="sm:max-w-[425px]">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Enter the amount of {countHabit.unit} you want to
                            add to your progress.
                        </DialogDescription>
                    </DialogHeader>
                    <Form
                        className="space-y-4"
